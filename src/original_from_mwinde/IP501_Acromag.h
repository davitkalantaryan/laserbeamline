...
#ifndef __INCIP501_Acromagh
#define __INCIP501_Acromagh
...
class IP501_Acromag : public RS485_Controller, public IPModule
{
  
   public:
	// --- creator
	IP501_Acromag(const char* ipCarrierName, off_t addr_offset, int channel=0);
