...
pitz::PoluxClient::MainWindow::MainWindow()
    :
...
void pitz::PoluxClient::MainWindow::CreateActions()
{
...
void pitz::PoluxClient::MainWindow::CreateMenus()
{
...
void pitz::PoluxClient::MainWindow::ConnectSlot()
{
...
void pitz::PoluxClient::MainWindow::DisconnectSlot()
{
    printf("!!!line:%d, fnc:%s\n",__LINE__,__FUNCTION__);
