...
#define COMMON_IO_SOCKET_SERVERTCP_HPP
...
class AcptType {
	typedef void(__THISCALL__* TypeAccept)(void* owner, typename SocketType& clientSock, const sockaddr_in* remoteAddr);
};
...
public:
	...
	template <typename SocketType>
	int	StartServerS(
		typename AcptType<SocketType>::TypeAccept fpAddClient,void* owner,
                int a_nPort, bool bReuse = true, bool a_bLoopback = false, int a_lnTimeout = 1000, int* retCode=NULL);
...
#endif // #ifndef COMMON_IO_SOCKET_SERVERTCP_HPP
